...
// return (
//     <div className=" mx-auto h-screen w-screenbg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 shadow-lg rounded-lg " style={{ marginTop: "50px", padding: "20px" }}>
//         {course.map((courseItem, index) => (
//             <div key={index} className="mb-8">
//                 <h2 className="text-2xl font-semibold text-indigo-800 mb-4">{courseItem.courseName}</h2>
...
//                             <li key={subject.subjectId} className="flex items-center space-x-2">
//                                 <span className="text-lg text-gray-800">{subject.subjectName}</span>
//                             </li>
//                         ))}
//                     </ul>
//                 </div>
